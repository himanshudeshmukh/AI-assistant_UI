...
//     _TipItem(
//         title: 'Color matching made simple',
//         time: '3 min read',
//         icon: Icons.star),
//     _TipItem(
//         title: '5 wardrobe essentials for men',
//         time: '5 min read',
//         icon: Icons.bolt),
//     _TipItem(
//         title: 'Grooming routine for beginners',
//         time: '4 min read',
//         icon: Icons.favorite),
//   ];
//
...
//                 children: <Widget>[
//                   Icon(Icons.search,
//                       color: _searchFocused ? _gold : const Color(0xFF666666)),
...
//                 child: Container(
//                   margin:
//                       EdgeInsets.only(right: item == _trending.first ? 8 : 0),
